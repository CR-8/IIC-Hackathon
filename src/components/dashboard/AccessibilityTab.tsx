  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          <ScrollArea className="h-[300px] pr-4">
            <div className="space-y-4">
              ...
              {data.wcag.errors.length === 0 &&
                data.wcag.warnings.length === 0 && (
        ...
        {/* AI-Detected Accessibility Issues */}
        {data.gemini && data.gemini.accessibilityIssues.length > 0 && (
          <AnalysisCard
            title="AI-Detected Accessibility Issues"
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-secondary/30 rounded-xl">
              <p className="text-2xl font-bold">
                {data.keyboard.interactiveElements.length}
              </p>
            ...
            <div className="flex items-center justify-between">
              ...
              <span
                className={`text-sm font-bold ${
                  data.sizing.feasibility === "Possible"
                    ? "text-green-600"
                    : "text-yellow-600"
                }`}
              >
